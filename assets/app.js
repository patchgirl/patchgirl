...
var author$project$Main$init = function (_n0) {
	...
	return _Utils_Tuple2(
		_Utils_Tuple3(model, httpRequestValidity, httpResponse),
...
var author$project$HttpHeader$parseHeaders = function (headers) {
	var parseRawHeader = function (rawHeader) {
		...
		if ((_n0.b && _n0.b.b) && (!_n0.b.b.b)) {
			var headerKey = _n0.a;
			var _n1 = _n0.b;
			var headerValue = _n1.a;
			return elm$core$Maybe$Just(
				_Utils_Tuple2(headerKey, headerValue));
		} else {
			return elm$core$Maybe$Nothing;
		}
	};
...
var author$project$HttpUrl$parseUrl = F2(
	function (model, url) {
		var urlRegex = A2(
			...
			elm$regex$Regex$fromString('(\\w+\\.\\w{2,}.*)|(localhost.*)'));
		var validUrl = A2(elm$regex$Regex$contains, urlRegex, url);
		var scheme = function () {
			var _n1 = model.httpScheme;
			if (_n1 === 'HTTP') {
				return 'http';
			} else {
				return 'https';
		...
		if (validUrl) {
			return elm$url$Url$fromString(scheme + ('://' + url));
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
				...
				return _Utils_Tuple2(
					_Utils_Tuple3(
						_Utils_update(
							model,
							{
								httpBody: elm$core$Maybe$Just(body)
							}),
						validity,
						mHttpResponse),
					elm$core$Platform$Cmd$none);
...
var author$project$HttpBody$view = function (method) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$hidden(whenGetMethod)
			]),
		_List_fromArray(
			[
				A2(
...
var author$project$HttpHeader$view = function (httpRequestValidity) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$id('headersBuilder')
			]),
		_List_fromArray(
			[
				A2(
...
var author$project$HttpResponse$view = function (mHttpResponse) {
		...
		if ((mHttpResponse.$ === 'Just') && (mHttpResponse.a.$ === 'Err')) {
			...
			switch (error.$) {
				...
				case 'BadStatus':
					...
					return 'Error ' + elm$core$String$fromInt(statusCode);
				default:
					var body = error.a;
					return 'Error ' + body;
			}
	...
	var response = function () {
		if ((mHttpResponse.$ === 'Just') && (mHttpResponse.a.$ === 'Ok')) {
			var responseBody = mHttpResponse.a.a;
			return responseBody;
		} else {
			return '';
		}
...
var author$project$HttpUrl$view = function (_n0) {
	...
	var status = function () {
		var _n1 = httpRequestValidity.urlValid;
		if (!_n1) {
			return 'Invalid Url';
		} else {
			return 'Send';
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$id('urlBuilder')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$value('HTTP')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$value('HTTPS')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('HTTPS')
							]))
					])),
				A2(
				elm$html$Html$input,
...
var author$project$Main$urlBuilderView = F3(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('tree')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('builder')
					]),
				A3(author$project$Main$urlBuilderView, model, httpRequestValidity, mHttpResponse))
			]));
};
